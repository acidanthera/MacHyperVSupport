...
OSDefineMetaClassAndAbstractStructors(HyperVKeyboardBase, super);

UInt32 HyperVKeyboardBase::deviceType() {
  //
  // Apple keyboard.
  //
  return 3;
...
UInt32 HyperVKeyboardBase::interfaceID() {
  return NX_EVS_DEVICE_INTERFACE_ADB;
}

const unsigned char* HyperVKeyboardBase::defaultKeymapOfLength(UInt32 * length) {
  //
...
UInt32 HyperVKeyboardBase::maxKeyCodes() {
  //
